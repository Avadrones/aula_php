            ...
            <div class="col-4">
                <form method="post">
                    <div class="mb-3">
                        ...
                        <input value="<?php echo intval ($numero1)?>" id="numero1" name="numero1" type="number" class="form-control">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input value="<?php echo intval ($numero2)?>" id="numero2" name="numero2" type="number" class="form-control">
                    </div>
                    <div class="mb-3">
