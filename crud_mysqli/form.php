...
// VERIFICAR SE EXISTE UMA VARIÁVEL NA URL CHAMADA "REF"
if(isset($_GET['ref'])) {
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col">
                                    ...
                                    <input value="<?php echo $nome?>" type="text" id="nome" name="nome" class="form-control">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="cpf" class="form-label">CPF</label>
                                    <input value="<?php echo $cpf?>"type="text" id="cpf" name="cpf"  class="form-control" data-mask="000.000.000-00">
                                </div>
                                <div class="col">
                                ...
                                <label for="email" class="form-label">E-mail</label>
                                    <input value="<?php echo $email?>"type="text" id="email"  name="email"  class="form-control">
                                </div>
                            </div>
                        </div>

                        <div class="card-footer text-end">
                        <button type="button" class="btn btn-outline-danger"><i class="bi bi-reply"></i></button>
